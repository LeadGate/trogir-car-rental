    ...
    <Layout>
      <SEOHead
        ...
        jsonLd={[{
          ...
          "@type": "WebPage",
          "name": "Privacy Policy | Trogir Car Rental",
          "url": "https://trogir-car-rental.com/privacy"
        }]}
      />
      ...
      >
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Your privacy matters to us. This page outlines how Trogir Car Rental collects, uses, and protects your information.
        </p>
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          If you have questions about this privacy policy, please contact us at <a href="mailto:info@trogir-car-rental.com" className="text-primary hover:underline">info@trogir-car-rental.com</a>.
        </p>
      </Section>
    </Layout>
  );

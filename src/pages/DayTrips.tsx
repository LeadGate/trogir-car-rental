  ...
  return (
    <Layout>
      ...
      >
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">Continuing inland toward Sinj shifts the landscape into the rugged Dinaric Alps foothills, with steeper grades, tighter bends, and more technical driving than the coastal routes. This is a good outing for experienced drivers who are comfortable with mountain roads and want a contrast to the flatter Dalmatian coast. Drivers extending the same hinterland route across the border can plan <a href="https://mostar-car-rental.com/" target="_blank" rel="noopener" className="text-primary underline hover:text-accent">the Mostar onward leg via the Imotski crossing</a>, which adds roughly three hours from Trogir into Herzegovina.</p>

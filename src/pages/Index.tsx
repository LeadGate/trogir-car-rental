...
const Index = () => {
  ...
  return (
    <Layout>
      ...
      >
          <p className="text-gray-700 mb-4 leading-relaxed">Local and international suppliers both operate around Split Airport and Trogir, but each company has a different mix of deposit rules, delivery options, and insurance add-ons. The descriptions below are self-contained and reflect the terms stated in the source text.</p>
